            ...
            <form action="{{ route('login') }}" method="post"class="needs-validation" novalidate>
                ...
                <div class="login_form">
                    <div class="form-floating mb-4">
                        <input type="email" class="form-control" name="email"="form2Example11"
                    ...
                    <div class="form-floating position-relative">
                        <input type="password" name="password" class="form-control" id="form2Example22"
...
//Scrit para mostrar el ojito en la vontraseña en el login
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const eyeButton = document.getElementById('eye-icon');
        const inputPass = document.getElementById('form2Example22');
