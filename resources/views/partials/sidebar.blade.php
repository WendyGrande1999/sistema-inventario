    ...
    @role('admin')
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#cierres-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-calendar2-date"></i><span>Cierres de inventario</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-bar-chart-line"></i></i><span>Reportes</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
